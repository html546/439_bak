      ...
      <div class="form_box1">
        <el-form ref="form" label-width="120px">
          <el-form-item :label="$t('transfer.balance')">
            <el-input v-model="form.money1" :readonly="true"></el-input>
          </el-form-item>
          ...
          <el-form-item :label="$t('transfer.max')">
            <el-input v-model="form.maxmoney" :readonly="true"></el-input>
          </el-form-item>
          <el-form-item :label="$t('transfer.multiple')">
            <el-input v-model="form.multiple" :readonly="true"></el-input>
          </el-form-item>
          ...
          <el-form-item :label="$t('transfer.pass2')" v-if="cashPass2 == 'true'">
      ...
      if (this.transfers.length) {
        ...
        for (const key in this.transfers) {
          if (key == val) {
            ...
            this.form.maxmoney = this.transfers[key].maxmoney;
            this.form.multiple = this.transfers[key].multiple;
            this.form.rate = this.transfers[key].exchange_rate;
            this.form.fee = this.transfers[key].servicecharge;
            if (this.transfers[key].isme == "0") {
              this.form.isme = false;
            }
          }
        }
